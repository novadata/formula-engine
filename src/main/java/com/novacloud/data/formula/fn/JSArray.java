...
class JSArray extends JSObject implements Invocable {
	...
	public Object splice(List<Object> thiz, Object... args)  {
		return slice(thiz, args);
	}

	public Object slice(List<Object> thiz, Object... args) {
		int size = thiz.size();
	...
	public Object toString(List<Object> thiz) {
		return join(thiz, ",");
	}
	...
	public Object pop(List<Object> thiz) {
		int size = thiz.size();
		if (size > 0) {
	...
	public Object shift(List<Object> thiz) {
		int size = thiz.size();
		if (size > 0) {
	...
	public Object reverse(List<Object> thiz) {
