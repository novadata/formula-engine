...
class NumberArithmetic {
	...
	private static int getNumberType(Number n1, Number n2) {
	...
	public Number add(Number n1, Number n2) {
		...
		case 4:// f
			// Floating point precision is very imprecise. For example, 16777216.0f + 1.0f = 16777216.0f.  using double math instead.
