...
public class ExpressionImpl implements Expression, ReferenceExpression,
	...
	public Object evaluate(Object context) throws ExpressionSyntaxException{
		try {
			Map<String, Object> contextMap = factory.wrapAsContext(context);
			return strategy.evaluate(expression, contextMap);
		}catch (Exception e){
	...
	public Object evaluate(Object... context) throws ExpressionSyntaxException{
		if (context == null || context.length == 0) {
			...
			throw new ExpressionSyntaxException("参数必须是偶数个数");
		}
